...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='D:\\code\\hook\\yolov8-main（hook4）\\runs\\train\\exp(YOLOv8s)\\weights\\best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='D:\\code\\hook\\yolov8-main（hook4）\\data\\Crane_hook.yaml', help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='exp（s-fasternet）', help='experiment name (project/name)')
    ...
    parser.add_argument('--max_det', type=int, default=300, help='maximum number of detections per images')
