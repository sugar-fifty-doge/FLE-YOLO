...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        for i in trange(int(post_result.size(0) * self.ratio)):
            ...
            cam_image.save(f'{save_path}/{i}.jpg')


def get_params():
    params = {
        'weight': 'D:\\code\\hook\\yolov8-main（hook4）\\runs\\train\\exp2(dyhead)\\weights\\best.pt',
        'cfg': 'D:\\code\\hook\\yolov8-main（hook4）\\ultralytics\\models\\v8\\yolov8s-dyhead.yaml',
        'device': 'cuda:0',
