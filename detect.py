...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='D:\\code\\hook\\yolov8-main（hook4）\\runs1\\train\\exp(BIattention)\\weights\\best.pt', help='training model path')
    parser.add_argument('--source', type=str, default='D:\\code\\hook\\yolov8-main（hook4）\\hooktest\\昏暗灯光下.jpg', help='source directory for images or videos')
    ...
    parser.add_argument('--augment', action="store_true", help='apply images augmentation to prediction sources')
