...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='D:\\code\\hook\\yolov8-main（hook4）\\ultralytics\\models\\v8\\yolov8-fasternet.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', type=str, default='exp（s-fasternet）', help='save to project/name')
